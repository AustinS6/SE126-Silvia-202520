#W6D1 - Searching Algorithms: Binarry vs Sequential Search
...
#SEQUENTIAL SEARCH: allow for a user to search for a specific title
...
while min < max and search_num != library_nums[mid]:
    ...
    #search_num != library_num[mid] --> what we are looking for is not the mid position
